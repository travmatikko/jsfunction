...
function createCompose(func1, func2) {
...
// Створюємо змінну createCompose якій присвоємо результат виконання функції compose з аргументами increment та double- я цього не робив навіщо воно треба??
console.log("Завдання 17 ====================================");
// Розкоментуйте після виконаня завдання
console.log("createCompose(5)", createCompose(5)); // Виведе: 11!! (5+1=6, 6*2=12???не знаю в мене 11 виходить)
